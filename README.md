...
Tone-Adaptive Text Rewriting – Rewrites input text into Neutral, Suspenseful, or Inspiring tones using IBM Watsonx LLM, while preserving original meaning and enhancing expressiveness.

High-Quality Voice Narration – Converts rewritten text into natural-sounding audio using IBM Watson Text-to-Speech with selectable voices like Lisa, Michael, or Allison.

Downloadable and Streamable Audio Output – Allows users to listen to audio directly in the app and download the final narration in .mp3 format for offline use.

Side-by-Side Text Comparison – Displays original and tone-adapted text together for easy verification and stylistic comparison.

User-Friendly Local Interface – Provides an intuitive Streamlit-based frontend

Technologies & Tools : Python, IBM Watson, Streamlit, TTS
